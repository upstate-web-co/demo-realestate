...
export const NEIGHBORHOODS = [
  { name: 'Downtown Greenville', description: 'Walkable, vibrant, close to Falls Park and Main Street. Median: $450K. Best for young professionals and empty nesters.', vibe: 'Urban' },
  { name: 'Augusta Road', description: 'Tree-lined streets, established homes, top-rated schools. Median: $550K. Best for families and long-term homeowners.', vibe: 'Classic' },
  { name: 'Travelers Rest', description: '15 minutes north, Swamp Rabbit Trail access, small-town charm with growing food scene. Median: $320K. Best for outdoor lovers.', vibe: 'Scenic' },
  { name: 'Simpsonville', description: 'Suburban, newer builds, great school district, lower price per sqft. Median: $350K. Best for growing families.', vibe: 'Suburban' },
]
